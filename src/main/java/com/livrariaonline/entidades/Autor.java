 ...
 */
@Entity
@Table(name = "autor", catalog = "ebooks", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Autor.findByUltimoNome", query = "SELECT a FROM Autor a WHERE a.ultimoNome = :ultimoNome")
    , @NamedQuery(name = "Autor.findByCriadoEm", query = "SELECT a FROM Autor a WHERE a.criadoEm = :criadoEm")})
public class Autor implements Serializable {
    ...
    public String toString() {
        return "Autor{" + "id=" + id + ", nome=" + nome + ", ultimoNome=" + ultimoNome + ", criadoEm=" + criadoEm + ", livroAutorList=" + livroAutorList + ", criadoPor=" + criadoPor + '}';
    }
