 ...
 */
@Entity
@Table(name = "fornecedor", catalog = "ebooks", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Fornecedor.findByCriadoEm", query = "SELECT f FROM Fornecedor f WHERE f.criadoEm = :criadoEm")})
public class Fornecedor implements Serializable {
    ...
    public String toString() {
        return "Fornecedor{" + "id=" + id + ", nome=" + nome + ", cnpj=" + cnpj + ", criadoEm=" + criadoEm + ", criadoPor=" + criadoPor + ", livroMovimentacoesList=" + livroMovimentacoesList + '}';
    }
